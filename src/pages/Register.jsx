    ...
    <div className="flex justify-center items-center min-h-[80vh] p-4">
      <div className="card w-full max-w-md shadow-2xl bg-[#1d232a] p-8 border border-gray-700">
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-5">
          ...
          <button type="submit" className="btn bg-[#00d1b2] hover:bg-[#00b89d] border-none text-black font-bold w-full mt-4 rounded-full text-lg shadow-lg transition-transform hover:scale-105">
            Register Now
          </button>
        </form>
